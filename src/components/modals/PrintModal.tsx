...
export default function PrintModal({ isOpen, onClose, data, config, companyInfo }: PrintModalProps) {
  ...
  const t = config.translations[selectedLanguage.code]
  ...
  const handlePrintAll = useCallback(() => {
    ...
    const currentTranslations = config.translations[selectedLanguage.code]
    ...
    // Xác định orientation và pageSize
      ...
      <head>
        ...
        <style>
          ...
          .print-table table {
            ...
            table-layout: ${pageOrientation === 'landscape' ? 'fixed' : 'auto'};
          }
          .print-th {
            ...
            max-width: ${pageOrientation === 'landscape' ? '80px' : '160px'};
            white-space: nowrap;
            overflow: hidden;
      ...
      <div id="print-content" className="print-content bg-white">
        ...
        <div className="print-table mb-8 preview-container">
          <table
            ...
            style={{ tableLayout: orientation === 'landscape' ? 'fixed' : 'auto' }}
          >
            <thead>
              <tr>
                <th
                  className="print-th border-2 border-gray-800 px-2 py-2 text-center text-xs font-bold bg-gray-100 w-12"
                ...
                {columnKeys.map((key) => (
                  <th
                    ...
                    style={{
                      maxWidth: orientation === 'landscape' ? '80px' : '160px',
                      whiteSpace: 'nowrap',
                      overflow: 'hidden',
            ...
            <tbody>
              {deferredData.slice(0, displayedItems).map((item, index) => (
                <tr key={item.id || index} className="print-row">
                  <td
                    className="print-td border border-gray-600 px-2 py-1.5 text-center text-xs"
                    style={{ maxWidth: '60px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
                  >
                    {index + 1}
                  </td>
                  {columnKeys.map((key) => (
                    <td
                      key={key}
                      className="print-td border border-gray-600 px-2 py-1.5 text-xs"
                      style={{
                        maxWidth: orientation === 'landscape' ? '80px' : '160px',
                        whiteSpace: 'nowrap',
                        overflow: 'hidden',
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2 bg-gray-100 rounded-lg p-1 ml-4">
                  ...
                  <button
                    ...
                    title="Ngang"
                  >
                    <span role="img" aria-label="landscape">🖼️</span>
                  </button>
                </div>
              </div>
